...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { name: @developer.name, specialization: @developer.specialization } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { name: @developer.name, specialization: @developer.specialization } }
